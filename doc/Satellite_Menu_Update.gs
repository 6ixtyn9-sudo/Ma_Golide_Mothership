/**
 * ======================================================================
 * FILE: Satellite_Menu_Update.gs
 * PURPOSE: Add Whole Shebang cleanup functions to satellite menu
 * USAGE: Replace your existing onOpen function with this updated version
 * ======================================================================
 */
...
function onOpen(e) {
  ...
  ui.createMenu('Ma Golide')
    ...
    .addSeparator()
    .addSubMenu(ui.createMenu('Whole Shebang Cleanup')
      .addItem('Validate Whole Shebang', 'runValidateWholeShebang')
      .addItem('Quick Cleanup', 'runQuickCleanup')
      .addSeparator()
      .addItem('RUN THE WHOLE SHEBANG', 'runTheWholeShebang'))
    .addToUi();
}
